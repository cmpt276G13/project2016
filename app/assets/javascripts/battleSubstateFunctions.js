...
function defeatEnter() {
    ...
    this.deathMessage = new textBox({x: game.scale.width / 2, y: game.scale.height / 2, width: game.scale.width / 3, height: 30, centerToPoint: true, horizontalAlign: "center", verticalAlign: "center"});
