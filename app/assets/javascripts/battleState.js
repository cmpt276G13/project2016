...
var battleState = {
    ...
    create: function() {
        ...
        this.mainActionsDisplay = new actionDisplay({x: 0, y: game.scale.height - actionBoxHeight, width: actionBoxWidth, height: actionBoxHeight, viewableObjects: 4}, ['fight', 'items', 'run', 'option4', 'option5', 'option6']);
